...
<div className="col-md-4">
  ...
  <div className="col-md-3">
    <label for="validationCustom01" className="form-label"> Pais</label>
    <input type="text" className="form-control" id="validationCustom01"  required/>
    <div className="valid-feedback">  
    </div>
  </div>
  ...
  <div className="col-md-3">
    <label for="validationCustom01" className="form-label">Departamento</label>
    <input type="text" className="form-control" id="validationCustom01"  required/>
    <div className="valid-feedback">
    </div>
  </div>
  ...
  <div className="col-md-3">
    <label for="validationCustom01" className="form-label"> Municipio/Ciudad</label>
    <input type="text" className="form-control" id="validationCustom01"  required/>
    <div className="valid-feedback">  
    </div>
  </div>
  ...
  <div className="col-md-3">
    <label for="validationCustom01" className="form-label">Direccion Exacta</label>
    <input type="text" className="form-control" id="validationCustom01"  required/>
    <div className="valid-feedback">
    </div>
  </div>
  ...
  <div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Descripcion del destino</label>
